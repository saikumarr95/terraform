...
location = "eastus"
private_dns_zone_name = "st-aiops-terraform-dns"
subnet_id = "sn-staiopsstorage-eus"
private_endpoint_name = "pe-st-aiops-terraform"
private_service_connection = "psc-st-aiops-terraform-private-connection"
